...
def build_test_fn(m):
    nodes = AtomicDiscourseRNNLM.build_full_model_graph(m)
...
training_exp_opt = common_utils.LazyBunch(
    ...
    model_cls=AtomicDiscourseRNNLM,
    build_train_fn=AtomicDiscourseRNNLM.build_full_model_graph,
    build_test_fn=AtomicDiscourseRNNLM.build_full_model_graph,
    training=True
)
